<template>
  <section>
    <div class="h86" style="overflow: hidden">
      <!-- 列表 -->
      <div v-show="listShow" class="h86" style="overflow: scroll">
        <div>
      ...
      <!-- 单人详细 -->
      <div v-if="detailShow" class="h86" style="overflow-y: scroll;overflow-x: hidden;">
        <el-button
          circle
